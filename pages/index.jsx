        ...
        <>
            ...
            <section className=''>
                <div className='grid h-screen overflow-hidden text-white parent'>
                    <main className='relative z-10 flex items-center justify-center bg-gradient-to-br from-spurple-500 to-spurple-600'>
                    ...
                    <aside className='relative flex flex-col items-center justify-end bg-gradient-to-r from-sgreen-500 to-sgreen-600'>
